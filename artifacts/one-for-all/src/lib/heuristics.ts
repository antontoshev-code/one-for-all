...
const BRAND_WORDS = new Set([
  ...
  "Twitter", "Туитър", "X", "Reddit", "Редит", "LinkedIn", "Линкедин",
  "Pinterest", "Snapchat", "Snapchat", "Twitch", "Discord", "Дискорд",
  "Threads", "Bluesky", "Mastodon", "Substack", "Medium", "Vimeo",
  "Dropbox", "Drive", "OneDrive", "iCloud", "Icloud", "Outlook", "Yahoo",
  "Chrome", "Safari", "Firefox", "Edge", "Brave", "Opera",
  "Windows", "Android", "iOS", "iPhone", "Iphone", "iPad", "Ipad", "Mac",
  "Steam", "Xbox", "PlayStation", "Nintendo", "Twitch",
  "Wikipedia", "Уикипедия", "ChatGPT", "OpenAI", "Anthropic", "Gemini",
  "Canva", "Miro", "Asana", "Jira", "Confluence", "Linear", "Airtable",
  "Shopify", "Stripe", "Wise", "Uber", "Lyft", "Yettel", "A1", "Vivacom",
  "Ryanair", "Wizz", "Lufthansa", "IKEA", "Икеа", "Decathlon", "Декатлон",
  "McDonald", "KFC", "Starbucks", "Subway", "Домино", "Happy",
